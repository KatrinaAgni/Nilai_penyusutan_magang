                ...
                <div class="card-body">
                    <form action="{{ route('buku.update', $buku->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="judul_buku" name="judul_buku" placeholder="Masukan Judul Buku" value="{{ $buku->judul_buku }}">
                            @error('judul_buku')
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_penerbit" id="id_penerbit" class="form-control">
                                ...
                                @foreach ($penerbit as $item)
                                    <option @if ($buku->id_penerbit = $item->id) selected @endif
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="tahun_terbit" name="tahun_terbit" placeholder="Masukan Tahun Terbit" value="{{ $buku->tahun_terbit }}">
                                @error('tahun_terbit')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="jml_halaman" name = "jml_halaman" placeholder = "Masukan Jumlah Halaman" value="{{ $buku->jml_halaman }}">
